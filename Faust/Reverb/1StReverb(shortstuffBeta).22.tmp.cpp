...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		interface->openVerticalBox("1StReverb(shortstuffBeta).22.tmp");
		...
		interface->addHorizontalSlider("dry", &fslider10, 1.0f, 0.0f, 1e+01f, 0.1f);
		...
		interface->addHorizontalSlider("wet", &fslider9, 5.0f, 0.0f, 1e+07f, 0.1f);
		interface->closeBox();
	}
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow32 = min(1000000000, max(0, fslider9));
