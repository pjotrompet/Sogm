IL = _; 															//(linkerinput)
IR = _; 															// Rechterinput
DelTime = hslider("Pre-DelTime's", 0.6, 0, 15, 0.1);			//UserInput to change the basic pre-delays (same ratio's)
UserFeBa = hslider("Roomsize", 0.81, 0, 1, 0.01);				//Amount of feedback for the delaylines
Volumeinputwet = hslider("wet", 5, 0, 100, 0.1);				//Amplification of the Wet signal
Volumeinputdry = hslider("dry", 1, 0, 100, 0.1);				//Amplification of the Dry signal
